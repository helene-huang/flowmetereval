...
CSV_DIR: Path = CURR_DIR / "csvs"
filepaths: list[Path] = [CSV_DIR / filename for filename in filenames]
output_filepath: Path = CURR_DIR / "cicids2017.csv"

def main() -> None:
    """
    NOTE: This script assumes all csv files are in the 'csvs' subdirectory and have the same header
    """
